    ...
    <div className="flex">
      <button
        ...
        className={classNames([
          'flex-grow flex justify-center rounded-l-full p-2 pl-3',
          optimisticLocation === 'HOME' ? 'bg-blue-800' : 'bg-blue-600',
        ])}
      >
        <svg
      ...
      <button
        ...
        className={classNames([
          'flex-grow flex justify-center p-2 border-l border-r border-blue-800',
          optimisticLocation === 'OFFICE' ? 'bg-blue-800' : 'bg-blue-600',
        ])}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <button
        ...
        className={classNames([
          'flex-grow flex justify-center rounded-r-full p-2 pr-3',
          optimisticLocation === 'AWAY' ? 'bg-blue-800' : 'bg-blue-600',
        ])}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
